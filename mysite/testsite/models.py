...
class Test_title(models.Model):
    ...
    questions_count = models.IntegerField(default=True, verbose_name='Количество вопросов')
    test_group = models.ForeignKey(Test_group, on_delete=models.CASCADE, verbose_name='Группа тестов')
...
class Question(models.Model):
    ...
    test_title = models.ForeignKey(Test_title, on_delete=models.CASCADE, verbose_name='Выбор теста')
